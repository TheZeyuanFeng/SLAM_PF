...
# j=load_joint_data('./data/train/train_joint0.mat')
# r=load_lidar_data('./data/train/train_lidar0.mat')
# print(r[10]['scan'])
# print(joint_name_to_index['Neck'])
# print(j['head_angles'][0,20000],j['head_angles'][1,20000])
# show_lidar(r)